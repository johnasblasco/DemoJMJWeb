      ...
      <div className="max-w-7xl mx-auto flex flex-col">
          ...
          <nav className="flex flex-col sm:flex-row flex-wrap gap-6 sm:gap-8 lg:gap-12 text-sm sm:text-base font-montserrat font-semibold tracking-wide uppercase">
            {["Home", "What we do", "Vision", "Mission", "Core values"].map((link) => (
              <a
                key={link}
                href="#"
                className="text-[#F4EFEA]/70 hover:text-white transition-colors duration-300"
              >
                {link}
              </a>
            ))}
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          ...
          <div className="flex gap-6">
            <a href="#" aria-label="Facebook" className="text-[#F4EFEA]/50 hover:text-white transition-colors">
            ...
            <a href="#" aria-label="Instagram" className="text-[#F4EFEA]/50 hover:text-white transition-colors">
            ...
            <a href="#" aria-label="Twitter" className="text-[#F4EFEA]/50 hover:text-white transition-colors">
